...
#
#
# ccall((:umfpack_di_solve, :libumfpack),
#
#  Int64,
#
#
# # suite sparse umfpack_di_solve                # your ccal         # your ccal inputs
# int sys,                                        Int64              0
# const int Ap [ ],                               Ptr{Int64},        lu.colptr
# const int Ai [ ],                               Ptr{Int64},        lu.rowval
# const double Ax [ ],                            Ptr{Float64},      lu.nzval
# double X [ ],                                   Ptr{Float64},      x
# const double B [ ],                             Ptr{Float64},      b
# void *Numeric,                                  Ptr{Cvoid},        lu.numeric
# const double Control [UMFPACK_CONTROL],         Ptr{Float64},      umf_ctrl
# double Info [UMFPACK_INFO]                      Ptr{Float64}),     umf_info
#
#
#
#          int sys,
...
function linear_solve!(solver, x::Vector{T}, A::SparseMatrixCSC{T,Int},
